			...
			<form action="Login">
                <p>
                    <label class="loginlabel" for="userid">
                        Username:</label>
                    <input class="logininput ui-keyboard-input ui-widget-content ui-corner-all" name="userid"
                ...
                <ul id="forgottenpassword">
                    ...
                    <li>
                        <input id="remember" type="checkbox" name="Rem" id="rememberMe"><label for="rememberMe">Remember
                            me</label></li>
                </ul>
                <center>
